...
/**
 * Created by vinay sharma on 30-01-2018.
 */

public class Entertainment extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.entertainment, null);
         progressDialog=new ProgressDialog(getActivity());
        rv = (RecyclerView) rootview.findViewById(R.id.Recyclerviewentertainment);
    ...
    public void onStart() {
        ...
        try {
            result = task.execute("https://newsapi.org/v2/top-headlines?country=in&category=entertainment&apiKey=23f5adcca2524cdaba37cc99a742eb48").get();
