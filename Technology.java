...
public class Technology extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public static Technology newInstance() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.technology, null);
        progressDialog=new ProgressDialog(getActivity());
        rv = (RecyclerView) rootview.findViewById(R.id.RecyclerviewTechnology);
    ...
    public void  onStart() {
        ...
        try {
            ...
            String result = task.execute("https://newsapi.org/v2/top-headlines?sources=techradar&apiKey=23f5adcca2524cdaba37cc99a742eb48").get();
