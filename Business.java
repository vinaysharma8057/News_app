...
public class Business extends Fragment implements SearchView.OnQueryTextListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootview = inflater.inflate(R.layout.business, null);

        rv = (RecyclerView) rootview.findViewById(R.id.Recyclerviewbusiness);
    ...
    public void onStart() {
        ...
        try {
            result = task.execute("https://newsapi.org/v2/top-headlines?sources=business-insider&apiKey=23f5adcca2524cdaba37cc99a742eb48").get();
